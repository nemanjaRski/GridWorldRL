...
cell = tf.compat.v1.nn.rnn_cell.LSTMCell(num_units=h_size, state_is_tuple=True)
cellT = tf.compat.v1.nn.rnn_cell.LSTMCell(num_units=h_size, state_is_tuple=True)
